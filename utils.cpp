...
int Inflate(const std::string &in_filename, const std::string &out_filename)
{
    ...
    else
    {
        ...
        std::filesystem::path inf(in_filename);
    ...
    {
        std::filesystem::path ouf(out_filename);
...
bool try_inflate(const std::filesystem::path &source, const std::filesystem::path &dest)
{
